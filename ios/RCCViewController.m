...
//  self.navigatorStyle = [NSMutableDictionary dictionaryWithDictionary:navigatorStyle];
  ...
  NSMutableDictionary *style = [[[RCCManager sharedInstance] getAppStyle] mutableCopy];
  style = style ? style : [NSMutableDictionary new];
  [style addEntriesFromDictionary:navigatorStyle];
  self.navigatorStyle = style;
